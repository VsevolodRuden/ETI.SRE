            ...
            function initializeRightGrid() {
                ...
                rightGrid.find(".k-grid-toolbar").on("click", ".k-pager-plus", addProduct);
            }
            ...
            function getRightFrameDataSource() {
                try {
                    var urlString = `/api/data/v9.1/eti_productassociationrules?$select=eti_min,eti_max,_eti_productcategory_value,_eti_bundleproduct_value&$filter=_eti_bundleproduct_value eq GUID`;
                    var priceLevelId = Xrm.Page.getAttribute("eti_associatedpricelist").getValue()[0].id;
                    var currentProductID = formContext.data.entity.getId();
            ...
            function detailInit(e) {
                ...
                let childGrid = $('<div/>')
                    ...
                    .kendoGrid({
                        ...
                        toolbar: kendo.template($("#template-detail").html()),
